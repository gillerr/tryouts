...
The scope is optional and should be the name of affected repo of `toolchain`

- **toolchain** (for the configuration, build process, releases...)
...
The footer is optional and should contain a reference to an issue if any, e.g.: `715`.
